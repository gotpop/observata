				...
				{!isLoading && searchResults.length > 0 && (
					<>
							...
							{searchResults.map((image) => (
								...
								>
									...
									<div className="unsplash-image-picker__image-info">
										<span className="unsplash-image-picker__photographer">{image.user.name}</span>
									</div>
								</div>
							))}
						</div>
						...
						<div className="unsplash-image-picker__pagination">
							<Button onClick={handlePrevPage} disabled={currentPage === 1} isSecondary>
							...
							<Button onClick={handleNextPage} disabled={currentPage === totalPages} isSecondary>
								{__('Next', 'observata')}
							</Button>
						</div>
					</>
