...
const CARD_SIMPLE_TEMPLATE = [
	[
		'observata/card-simple',
		{
			...
			description:
				'Enable your employees to securely and fast locate information across all internal systems.',
			iconGeo: '01',
		},
	],
	[
		'observata/card-simple',
		{
			...
			description:
				'We protect your critical assets 24/7. Detecting threats, responding fast and preventing attacks.',
			iconGeo: '02',
		},
	],
	[
		'observata/card-simple',
		{
			...
			description: 'Powered by Elastic. Managed by experts. Detect early, respond fast.',
			iconGeo: '03',
		},
	],
];
